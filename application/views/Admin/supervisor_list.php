...
<div class="page-header page-header-light">
   <div class="page-header-content header-elements-md-inline">
      ...
      <div class="header-elements d-none">
         ...
         <?php if($load_permission->is_add == '1') {?><a href="<?php echo base_url('Admin/Supervisor/add');?>" class="btn btn-primary btn-sm waves-effect waves-light m-1">Add New</a><?php }?>
         </div>
      </div>
   </div>
               ...
               <form action="<?php echo base_url('Admin/Contractor');?>" method="post" enctype="multipart/form-data" accept-charset="utf-8">   
                  ...
                  <div class="table-responsive">
                           <table class="table datatable-basic table-bordered">
                              ...
                              <tbody>
                                 <?php $sr = 1;
                                 foreach ($supervisor_info as $value) { 

                                    $designation_info= get_Details('designation',array('designation_id'=>$value->designation_id),'single');
                                    ?>
                                    <tr>
                                       <td><?php echo $sr;
                                             $sr++; //$value->store_id;
                                          ...
                                          <div class="list-icons-item dropdown">
                                             ...
                                             <div class="dropdown-menu dropdown-menu-right">
                                                ...
                                                <?php if($load_permission->is_delete == '1') {?>
                                                   <a onclick="return confirm('<?php echo $this->lang->line('delete_confirmation');?>')" href="<?php echo base_url('Admin/Supervisor/del/'.base64_encode($value->supervisor_id));?>" class="dropdown-item"><i class="icon-trash-alt"></i> Delete</a>
                                                <?php }?>
                                                <?php if($load_permission->is_view == '1') {?>
                                                   <a href="<?php echo base_url('Admin/Supervisor/view/'.base64_encode($value->supervisor_id));?>" class="dropdown-item"><i class="icon-three-bars"></i> View</a>
                                                <?php }?>
                                             </div>
                                          </div>
                                       </div>
