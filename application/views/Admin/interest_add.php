   ...
   <div class="row">
      <div class="col-xl-12">
         <div class="card">
            ...
            <div class="card-body">
               <form action="<?php echo base_url('Admin/Interest/add');?>" method="post" enctype="multipart/form-data" accept-charset="utf-8">
                  <div class="row">
                              ...
                              <select class="form-control" id="project_id" name="project_id" required>
                                 <?php $select_project_id = '';
                                       if($this->input->post('submit')) {
                                          ...
                                          $select_project_id = $interest_info->project_id;
                                       }?>
                              ...
                              <select class="form-control" id="project_activity_id" name="project_activity_id">
                                 <?php $select_project_activity_id = '';
                                       if($this->input->post('submit')) {
                                          ...
                                          $select_project_activity_id = $interest_info->project_activity_id;
                                       }?>
                           ...
                           <div class="col-md-12 col-sm-12 col-xs-12">
                              <?php $bill_no_value = '';
                                    if ($this->input->post('submit')) {
                                       ...
                                       $bill_no_value = $interest_info->bill_no;
                                    }?>
                     ...
                     <div class="col-md-4 col-sm-4 col-xs-12">
                        <div class="form-group row">
                           <label for="input-21" class="col-md-12 col-sm-12 col-xs-12 col-form-label">Interest Amount <span class="text-hightlight">*</span></label>
                           <div class="col-md-12 col-sm-12 col-xs-12">
                     ...
                     <div class="col-md-4 col-sm-4 col-xs-12">
                        <div class="form-group row">
                           <label for="input-21" class="col-md-12 col-sm-12 col-xs-12 col-form-label">Final Amount <span class="text-hightlight">*</span></label>
                           <div class="col-md-12 col-sm-12 col-xs-12">
                              <?php $net_amount_released_value = '0';
                                    if ($this->input->post('submit')) {
                                       $net_amount_released_value = $this->input->post('net_amount_released');
                           ...
                           <div class="col-md-12 col-sm-12 col-xs-12">
                              <select class="form-control" id="payment_mode_id" name="payment_mode_id" required>
                                 ...
                                 if ($this->input->post('submit')) {
                                    ...
                                    $select_payment_mode_id = $interest_info->payment_mode_id;
                                 } ?>
                        ...
                        <div class="form-group row">
                           ...
                           <div class="col-md-12 col-sm-12 col-xs-12">
                              ...
                              if ($this->input->post('submit')) {
                                 ...
                                 $select_bank_id = $interest_info->bank_id;
                              } ?>
                        ...
                        <div class="form-group row">
                           ...
                           <div class="col-md-12 col-sm-12 col-xs-12">
                              ...
                              if ($this->input->post('submit')) {
                                 ...
                                 $transaction_no = $interest_info->transaction_no;
                              } ?>
                        ...
                        <div class="form-group row">
                           ...
                           <div class="col-md-12 col-sm-12 col-xs-12">
                              ...
                              if ($this->input->post('submit')) {
                                 ...
                                 $transaction_date_value = $interest_info->transaction_date;
                              } ?>
                           ...
                           <div class="col-md-12 col-sm-12 col-xs-12">
                              <?php $remarks_value = '';
                                    if ($this->input->post('submit')) {
                                       ...
                                       $remarks_value = $interest_info->remarks;
                                    } ?>
