...
<div class="row">
   <div class="col-md-12 col-sm-12 col-xs-12">
      <div class="card">
         <div class="card-header">
            <div class="row">
               ...
               <div class="col-md-6 col-sm-6 col-xs-12 text-right">
                  <a href="<?php echo base_url('Admin/ManagePacking');?>" class="btn btn-primary btn-sm waves-effect waves-light m-1">Back</a>
               </div>
            </div>
         ...
         <div class="card-body">
            <form action="<?php echo base_url('Admin/ManagePacking/add');?>" method="post" enctype="multipart/form-data" accept-charset="utf-8">
               <div class="row">
                  <div class="col-md-4 col-sm-4 col-xs-12">
                     <div class="form-group row">
                        <label for="input-21" class="col-md-12 col-sm-12 col-xs-12 col-form-label">Packing Title <span class="text-hightlight">*</span></label>
                        <div class="col-md-12 col-sm-12 col-xs-12">
                           <?php $packing_title_value = '';
                              if($this->input->post('submit')) {
                              $packing_title_value = $this->input->post('packing_title');	 
                              } else if(!empty($packing_info)) {
                                  $packing_title_value = $packing_info->packing_title;
                              }?>
                           <input type="text" required id="packing_title" name="packing_title" placeholder="Enter your packing title" class="form-control" maxlength="255" value="<?php echo $packing_title_value;?>" />
                           <span class="badge badge-danger m-1"><?php echo form_error('packing_title');?></span>
                        </div>
                     </div>
                  </div>
                  <div class="col-md-4 col-sm-4 col-xs-12">
                     <div class="form-group row">
                        <label for="input-21" class="col-md-12 col-sm-12 col-xs-12 col-form-label">Packing Value <span class="text-hightlight">*</span></label>
                        <div class="col-md-12 col-sm-12 col-xs-12">
                           <?php $packing_value_value = '';
                              if($this->input->post('submit')) {
                                 $packing_value_value = $this->input->post('packing_value');	 
                              } else if(!empty($packing_info)) {
                                 $packing_value_value = $packing_info->packing_value;
                              }?>
                           <input type="text" required id="packing_value" name="packing_value" placeholder="Enter packing value" class="form-control" minlength="0" maxlength="10" value="<?php echo $packing_value_value;?>" autocomplete="off" />
                           <span class="badge badge-danger m-1"><?php echo form_error('packing_value');?></span>
                        </div>
                     </div>
                  </div>
                  <div class="col-md-4 col-sm-4 col-xs-12">
                           ...
                           <select class="form-control" id="unit_id" name="unit_id" required>
                              <?php $select_unit_id = '';
                                    if($this->input->post('submit')) {
                                        ...
                                        $select_unit_id = $packing_info->unit_id;
                                    }?>
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-6">
                           ...
                           <?php $display_value = '';
                              if($this->input->post('submit')) {
                                 ...
                                 $display_value = $packing_info->display;
                              }?>
                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12">
                           <?php $priority_value = '';
                              ...
                              $priority_value = $this->input->post('priority');	 
                                  ...
                                  $priority_value = $packing_info->priority;
                              }?>
