                        ...
                        <tr>
                           <td>
                              <div class="d-flex align-items-center">
                                 <div class="mr-3">
                                    <a href="#">
                                       <img src="<?php echo base_url('global_assets/images/brands/facebook.png');?>" class="rounded-circle" width="32" height="32" alt="">
                                    </a>
                                 </div>
                                 <div>
                        ...
                        <tr>
                           <td>
                              <div class="d-flex align-items-center">
                                 <div class="mr-3">
                                    <a href="#">
                                       <img src="<?php echo base_url('global_assets/images/brands/youtube.png');?>" class="rounded-circle" width="32" height="32" alt="">
                                    </a>
                                 </div>
                                 <div>
                        ...
                        <tr>
                           <td>
                              <div class="d-flex align-items-center">
                                 <div class="mr-3">
                                    <a href="#">
                                       <img src="<?php echo base_url('global_assets/images/brands/spotify.png');?>" class="rounded-circle" width="32" height="32" alt="">
                                    </a>
                                 </div>
                                 <div>
                        ...
                        <tr>
                           <td>
                              <div class="d-flex align-items-center">
                                 <div class="mr-3">
                                    <a href="#">
                                       <img src="<?php echo base_url('global_assets/images/brands/twitter.png');?>" class="rounded-circle" width="32" height="32" alt="">
                                    </a>
                                 </div>
                                 <div>
                        ...
                        <tr>
                           <td>
                              <div class="d-flex align-items-center">
                                 <div class="mr-3">
                                    <a href="#">
                                       <img src="<?php echo base_url('global_assets/images/brands/bing.png');?>" class="rounded-circle" width="32" height="32" alt="">
                                    </a>
                                 </div>
                                 <div>
                        ...
                        <tr>
                           <td>
                              <div class="d-flex align-items-center">
                                 <div class="mr-3">
                                    <a href="#">
                                       <img src="<?php echo base_url('global_assets/images/brands/amazon.png');?>" class="rounded-circle" width="32" height="32" alt="">
                                    </a>
                                 </div>
                                 <div>
                        ...
                        <tr>
                           <td>
                              <div class="d-flex align-items-center">
                                 <div class="mr-3">
                                    <a href="#">
                                       <img src="<?php echo base_url('global_assets/images/brands/dribbble.png');?>" class="rounded-circle" width="32" height="32" alt="">
                                    </a>
                                 </div>
                                 <div>
                        ...
                        <tr>
                           ...
                           <td>
                              <div class="d-flex align-items-center">
                                 <div class="mr-3">
                                    <a href="#">
                                       <img src="<?php echo base_url('global_assets/images/demo/users/face15.jpg');?>" class="rounded-circle" width="32" height="32" alt="">
                                    </a>
                                 </div>
                                 <div>
                        ...
                        <tr>
                           ...
                           <td>
                              <div class="d-flex align-items-center">
                                 <div class="mr-3">
                                    <a href="#">
                                       <img src="<?php echo base_url('global_assets/images/demo/users/face3.jpg');?>" class="rounded-circle" width="32" height="32" alt="">
                                    </a>
                                 </div>
                                 <div>
                        ...
                        <tr>
                           ...
                           <td>
                              <div class="d-flex align-items-center">
                                 <div class="mr-3">
                                    <a href="#">
                                       <img src="<?php echo base_url('global_assets/images/demo/users/face8.jpg');?>" class="rounded-circle" width="32" height="32" alt="">
                                    </a>
                                 </div>
                                 <div>
                     ...
                     <div class="col-xl-6">
                        <div class="media flex-column flex-sm-row mt-0 mb-3">
                           <div class="mr-sm-3 mb-2 mb-sm-0">
                              <div class="card-img-actions">
                                 <a href="#">
                                    <img src="<?php echo base_url('global_assets/images/demo/flat/1.png');?>" class="img-fluid img-preview rounded" alt="">
                        ...
                        <div class="media flex-column flex-sm-row mt-0 mb-3">
                           <div class="mr-sm-3 mb-2 mb-sm-0">
                              <div class="card-img-actions">
                                 <a href="#">
                                    <img src="<?php echo base_url('global_assets/images/demo/flat/21.png');?>" class="img-fluid img-preview rounded" alt="">
                                    <span class="card-img-actions-overlay card-img"><i class="icon-play3 icon-2x"></i></span>
                                 </a>
                              </div>
                           </div>
                     ...
                     <div class="col-xl-6">
                        <div class="media flex-column flex-sm-row mt-0 mb-3">
                           <div class="mr-sm-3 mb-2 mb-sm-0">
                              <div class="card-img-actions">
                                 <a href="#">
                                    <img src="<?php echo base_url('global_assets/images/demo/flat/12.png');?>" class="img-fluid img-preview rounded" alt="">
                                    <span class="card-img-actions-overlay card-img"><i class="icon-play3 icon-2x"></i></span>
                                 </a>
                              </div>
                           </div>
                        ...
                        <div class="media flex-column flex-sm-row mt-0 mb-3">
                           <div class="mr-sm-3 mb-2 mb-sm-0">
                              <div class="card-img-actions">
                                 <a href="#">
                                    <img src="<?php echo base_url('global_assets/images/demo/flat/15.png');?>" class="img-fluid img-preview rounded" alt="">
                                    <span class="card-img-actions-overlay card-img"><i class="icon-play3 icon-2x"></i></span>
                                 </a>
                              </div>
                           </div>
               ...
               <div class="tab-content card-body">
                     ...
                     <ul class="media-list">
                        <li class="media">
                           <div class="mr-3 position-relative">
                              <img src="<?php echo base_url('global_assets/images/demo/users/face10.jpg');?>" class="rounded-circle" width="36" height="36" alt="">
                        ...
                        <li class="media">
                           <div class="mr-3 position-relative">
                              <img src="<?php echo base_url('global_assets/images/demo/users/face3.jpg');?>" class="rounded-circle" width="36" height="36" alt="">
                        ...
                        <li class="media">
                           <div class="mr-3">
                              <img src="<?php echo base_url('global_assets/images/demo/users/face24.jpg');?>" class="rounded-circle" width="36" height="36" alt="">
                           </div>
                        ...
                        <li class="media">
                           <div class="mr-3">
                              <img src="<?php echo base_url('global_assets/images/demo/users/face4.jpg');?>" class="rounded-circle" width="36" height="36" alt="">
                           </div>
                        ...
                        <li class="media">
                           <div class="mr-3">
                              <img src="<?php echo base_url('global_assets/images/demo/users/face25.jpg');?>" class="rounded-circle" width="36" height="36" alt="">
                           </div>
                  ...
                  <div class="tab-pane fade" id="messages-mon">
                     <ul class="media-list">
                        <li class="media">
                           <div class="mr-3">
                              <img src="<?php echo base_url('global_assets/images/demo/users/face2.jpg');?>" class="rounded-circle" width="36" height="36" alt="">
                           </div>
                        ...
                        <li class="media">
                           <div class="mr-3">
                              <img src="<?php echo base_url('global_assets/images/demo/users/face7.jpg');?>" class="rounded-circle" width="36" height="36" alt="">
                           </div>
                        ...
                        <li class="media">
                           <div class="mr-3">
                              <img src="<?php echo base_url('global_assets/images/demo/users/face18.jpg');?>" class="rounded-circle" width="36" height="36" alt="">
                           </div>
                        ...
                        <li class="media">
                           <div class="mr-3">
                              <img src="<?php echo base_url('global_assets/images/demo/users/face14.jpg');?>" class="rounded-circle" width="36" height="36" alt="">
                           </div>
                        ...
                        <li class="media">
                           <div class="mr-3">
                              <img src="<?php echo base_url('global_assets/images/demo/users/face8.jpg');?>" class="rounded-circle" width="36" height="36" alt="">
                           </div>
                  ...
                  <div class="tab-pane fade" id="messages-fri">
                     <ul class="media-list">
                        <li class="media">
                           <div class="mr-3">
                              <img src="<?php echo base_url('global_assets/images/demo/users/face15.jpg');?>" class="rounded-circle" width="36" height="36" alt="">
                           </div>
                        ...
                        <li class="media">
                           <div class="mr-3">
                              <img src="<?php echo base_url('global_assets/images/demo/users/face12.jpg');?>" class="rounded-circle" width="36" height="36" alt="">
                           </div>
                        ...
                        <li class="media">
                           <div class="mr-3">
                              <img src="<?php echo base_url('global_assets/images/demo/users/face22.jpg');?>" class="rounded-circle" width="36" height="36" alt="">
                           </div>
                        ...
                        <li class="media">
                           <div class="mr-3">
                              <img src="<?php echo base_url('global_assets/images/demo/users/face17.jpg');?>" class="rounded-circle" width="36" height="36" alt="">
                           </div>
