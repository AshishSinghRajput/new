...
<div class="row">
   <div class="col-md-12 col-sm-12 col-xs-12">
      <div class="card">
         ...
         <div class="card-body">
            <form action="<?php echo base_url('Admin/ManageStore/edit/' . base64_encode($store_id)); ?>" method="post" enctype="multipart/form-data" accept-charset="utf-8">
               <div class="row">
