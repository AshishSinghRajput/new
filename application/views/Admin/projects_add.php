    ...
    <div class="row">
        <div class="col-xl-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="<?php echo base_url('Admin/Projects/add');?>" method="post"
                                          ...
                                          if ($this->input->post('submit')) {
                                             ...
                                             $account_no = $projects_bank_info->account_no;
                                                ...
                                                <input type="text" id="account_no_<?php echo $row;?>"
                                                    ...
                                                    class="form-control" value="<?php echo $account_no; ?>" maxlength="25" />
                                                <span
                                          ...
                                          if ($this->input->post('submit')) {
                                             ...
                                             $ifsc_code = $projects_bank_info->ifsc_code;
                                                ...
                                                <input type="text" id="ifsc_code_<?php echo $row;?>"
                                                    ...
                                                    class="form-control" value="<?php echo $ifsc_code; ?>" maxlength="20" />
                                                <span
                                          ...
                                          if ($this->input->post('submit')) {
                                             ...
                                             $branch = $projects_bank_info->branch;
                                                ...
                                                <input type="text" id="branch_<?php echo $row;?>"
                                                    ...
                                                    class="form-control" value="<?php echo $branch; ?>" maxlength="255" />
                                                <span
