         ...
         <div class="card-header">
            <div class="row">
               ...
               <div class="col-md-6 col-sm-6 col-xs-12 text-right">
                  <a href="<?php echo base_url('Admin/ManageTaxesGroup');?>" class="btn btn-primary btn-sm waves-effect waves-light m-1">Back</a>
               </div>
            </div>
               ...
               <div class="row">
                  <div class="col-md-4 col-sm-4 col-xs-12">
                     <div class="form-group row">
                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12">
                           <?php $taxes_group_value = '';
                              if($this->input->post('submit')) {
                              $taxes_group_value = $this->input->post('taxes_group');	 
                              } else if(!empty($taxes_group_info)) {
                                  $taxes_group_value = $taxes_group_info->taxes_group;
                              }?>
                           <input type="text" required id="taxes_group" name="taxes_group" placeholder="Enter your taxes group" class="form-control" maxlength="255" value="<?php echo $taxes_group_value;?>" />
                           <span class="badge badge-danger m-1"><?php echo form_error('taxes_group');?></span>
                        </div>
                     </div>
                  </div>
                  <div class="col-md-4 col-sm-4 col-xs-12">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-6">
                           ...
                           <?php $display_value = '';
                              if($this->input->post('submit')) {
                                 ...
                                 $display_value = $taxes_group_info->display;
                              }?>
                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12">
                           <?php $priority_value = '';
                              ...
                              $priority_value = $this->input->post('priority');	 
                                  ...
                                  $priority_value = $taxes_group_info->priority;
                              }?>
