   ...
   <div class="row">
      <div class="col-xl-12">
         <div class="card">
            ...
            <div class="card-body">
            <form action="<?php echo base_url('Admin/ManageStore/view/' . base64_encode($contractor_id)); ?>" method="post" enctype="multipart/form-data" accept-charset="utf-8">
               <div class="row">
                  ...
                  <div class="col-md-4 col-sm-4 col-xs-12">
                     <div class="form-group row">
                        <label for="input-21" class="col-md-12 col-sm-12 col-xs-12 col-form-label">Firm Type</label>
                        <div class="col-md-12 col-sm-12 col-xs-12">
                  ...
                  <div class="col-md-12 col-sm-12 col-xs-12">
                     ...
                     <div class="table-responsive">
                        <table class="table datatable-basic">
                           ...
                           <tbody>
                           <?php if(!empty($supplier_bank_info)) {?>
                           <?php $sr = 1;
                              foreach($supplier_bank_info as $value) {?>
                              <tr>
                     ...
                     <table class="table datatable-basic table-bordered">
                        ...
                        <tbody>
                           ...
                           <tr>
                              ...
                              <?php /*<td><?php $contractor_info = $this->UsersMstModel->get_record($value->contractor_id);
