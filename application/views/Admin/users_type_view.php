   ...
   <div class="page-header-content header-elements-md-inline">
      ...
      <div class="header-elements d-none">
         <div class="d-flex justify-content-center">
            ...
            <?php if($load_permission->is_edit == '1') {?><a href="<?php echo base_url('Admin/ManageUsersType/edit/'.base64_encode($users_type_info->users_type_id));?>" class="btn btn-primary btn-sm waves-effect waves-light m-1">Edit</a><?php }?>
            <?php if($load_permission->is_edit == '1') {?><a onclick="return confirm('<?php echo $this->lang->line('delete_confirmation');?>')" href="<?php echo base_url('Admin/ManageUsersType/del/'.base64_encode($users_type_info->users_type_id));?>" class="btn btn-danger btn-sm waves-effect waves-light m-1">Delete</a><?php }?>
