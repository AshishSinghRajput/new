                        ...
                        <table id="example" class="table table-bordered">
                           ...
                           <tbody>
                              ...
                              <tr>
                                 ...
                                 <td class="text-center"><?php if($load_permission->is_edit == '1') {?><a href="<?php echo base_url('Admin/ManageUsersType/edit/'.base64_encode($value->users_type_id));?>" class="btn btn-primary btn-sm waves-effect waves-light m-1">Edit</a><?php }?> <?php if($load_permission->is_delete == '1') {?><a onclick="return confirm('<?php echo $this->lang->line('delete_confirmation');?>')" href="<?php echo base_url('Admin/ManageUsersType/del/'.base64_encode($value->users_type_id));?>" class="btn btn-danger btn-sm waves-effect waves-light m-1">Delete</a><?php }?> <?php if($load_permission->is_view == '1') {?><a href="<?php echo base_url('Admin/ManageUsersType/view/'.base64_encode($value->users_type_id));?>" class="btn btn-info btn-sm waves-effect waves-light m-1">View</a><?php }?></td>
                              </tr>
                              <?php }?>
                           </tbody>
                        </table>
