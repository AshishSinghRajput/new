   ...
   <div class="page-header-content header-elements-md-inline">
      ...
      <div class="header-elements d-none">
         <div class="d-flex justify-content-center">
            <?php if($load_permission->is_add == '1') {?><a href="<?php echo base_url('Admin/Interest/add');?>" class="btn btn-primary btn-sm waves-effect waves-light m-1">Add New</a><?php }?>
            <?php if($load_permission->is_edit == '1') {?><a href="<?php echo base_url('Admin/Interest/edit/'.base64_encode($interest_info->interest_id));?>" class="btn btn-primary btn-sm waves-effect waves-light m-1">Edit</a><?php }?>
            <?php if($load_permission->is_edit == '1') {?><a onclick="return confirm('<?php echo $this->lang->line('delete_confirmation');?>')" href="<?php echo base_url('Admin/Interest/del/'.base64_encode($interest_info->interest_id));?>" class="btn btn-danger btn-sm waves-effect waves-light m-1">Delete</a><?php }?>
            <a href="<?php echo base_url('Admin/Interest');?>" class="btn btn-primary btn-sm waves-effect waves-light m-1">Back</a>
         </div>
      </div>
   </div>
   ...
   <div class="row">
      <div class="col-xl-12">
         <div class="card">
            ...
            <div class="card-body">
               <form action="<?php echo base_url('Admin/Interest/edit/'.base64_encode($interest_id));?>" method="post" enctype="multipart/form-data" accept-charset="utf-8">
                  <div class="row">                      
                     <div class="col-md-4 col-sm-4 col-xs-12">
                        <div class="form-group row">
                           <label for="input-21" class="col-md-12 col-sm-12 col-xs-12 col-form-label">Scheme Name</label>
                           <div class="col-md-12 col-sm-12 col-xs-12">
                              <?php $projects_info = $this->ProjectsMstModel->get_record($login_info->department_id, $interest_info->project_id);
                     ...
                     <div class="col-md-4 col-sm-4 col-xs-12">
                        <div class="form-group row">
                           ...
                           <div class="col-md-12 col-sm-12 col-xs-12">
                              <?php $project_activity_info = $this->ProjectsActivitesMstModel->get_record($login_info->department_id, '', $interest_info->project_activity_id);
                     ...
                     <div class="col-md-4 col-sm-4 col-xs-12">
                        <div class="form-group row">
                           ...
                           <div class="col-md-12 col-sm-12 col-xs-12">
                              <?php echo $interest_info->bill_no;?>
                           </div>
                        </div>
                     </div>
                     <div class="col-md-4 col-sm-4 col-xs-12">
                     ...
                     <div class="col-md-4 col-sm-4 col-xs-12">
                        <div class="form-group row">
                           ...
                           <div class="col-md-12 col-sm-12 col-xs-12">
                              <?php echo $this->customlib->inr_format($interest_info->gross_amount);?>
                           </div>
                        </div>
                     </div>
                     <div class="col-md-4 col-sm-4 col-xs-12" style="display: none;">
                        <div class="form-group row">
                           ...
                           <div class="col-md-12 col-sm-12 col-xs-12">
                              <?php echo $this->customlib->inr_format($interest_info->net_amount_released);?>
                           </div>
                        </div>
                     </div>
                     <div class="col-md-4 col-sm-4 col-xs-12" style="display: none;">
                        <div class="form-group row">
                           ...
                           <div class="col-md-12 col-sm-12 col-xs-12">
                              <?php $payment_mode_info = $this->PaymentModeMstModel->get_record($interest_info->payment_mode_id);
                     ...
                     <div class="col-md-4 col-sm-4 col-xs-12">
                        <div class="form-group row">
                           ...
                           <div class="col-md-12 col-sm-12 col-xs-12">
                              <?php $bank_info = $this->BankMstModel->get_record($interest_info->bank_id);
                     ...
                     <div class="col-md-4 col-sm-4 col-xs-12" style="display: none;">
                        <div class="form-group row">
                           ...
                           <div class="col-md-12 col-sm-12 col-xs-12">
                              <?php echo $interest_info->transaction_no; ?>
                           </div>
                        </div>
                     </div>
                     <div class="col-md-4 col-sm-4 col-xs-12" style="display: none;">
                     ...
                     <div class="col-md-4 col-sm-4 col-xs-12">
                        <div class="form-group row">
                           ...
                           <div class="col-md-12 col-sm-12 col-xs-12">
                              <?php echo $interest_info->remarks;?>
                           </div>
                        </div>
                     </div>
                  </div>
                  ...
                  <div class="row">
                     <div class="col-md-4 col-sm-4 col-xs-12">
                           <div class="form-group row">
                              ...
                              <div class="col-md-12 col-sm-12 col-xs-12">
                                 <?php if($interest_info->status_id == 'Pending') {?>
                                    <span class="badge bg-grey-400"><?php echo $interest_info->status_id;?></span>
                                 <?php } else if($interest_info->status_id == 'In-Progress') {?>
                                    <span class="badge badge-info"><?php echo $interest_info->status_id;?></span>
                                 <?php } else if($interest_info->status_id == 'Accepted') {?>
                                    <span class="badge badge-primary"><?php echo $interest_info->status_id;?></span>
                                 <?php } else if($interest_info->status_id == 'Rejected') {?>
                                    <span class="badge badge-danger"><?php echo $interest_info->status_id;?></span>
                                 <?php }?>  
                              </div>
                           </div>
                     </div>
                     ...
                     <div class="col-md-4 col-sm-4 col-xs-12">
                           <div class="form-group row">
                              <label for="input-21" class="col-md-12 col-sm-12 col-xs-12 col-form-label">Remarks</label>
                              <div class="col-md-12 col-sm-12 col-xs-12">
                                 <?php echo $interest_info->status_remarks; ?>
                              </div>
                           </div>
                     </div>
                  </div>
                  ...
                  <div class="row">
                     <div class="col-md-4 col-sm-4 col-xs-12">
                           <div class="form-group row">
                              ...
                              <div class="col-md-12 col-sm-12 col-xs-12">
                                 <?php if ($interest_info->is_cancel == 'Yes') { ?><span class="badge badge-danger m-1">Yes</span><?php } else if ($interest_info->is_cancel == 'No') { ?><span class="badge badge-primary m-1">No</span><?php } ?>
                              </div>
                           </div>
                     </div>
                     <div class="col-md-4 col-sm-4 col-xs-12">
                     ...
                     <div class="col-md-4 col-sm-4 col-xs-12">
                           <div class="form-group row">
                              ...
                              <div class="col-md-12 col-sm-12 col-xs-12">
                                 <?php echo $interest_info->cancel_reason; ?>
                              </div>
                           </div>
                     </div>
                  </div>
