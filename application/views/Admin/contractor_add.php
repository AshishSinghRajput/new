    ...
    <div class="row">
        <div class="col-xl-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="<?php echo base_url('Admin/Contractor/add'); ?>" method="post"
                                    ...
                                    <div class="col-md-4 col-sm-4 col-xs-4">
                                        <div class="">
                                            ...
                                            <input type="radio" id="firm_type" name="firm_type" value="Individual"
                                                <?php if ($firm_type_value == '0') { ?>checked="checked" <?php } ?> />
                                    ...
                                    <div class="col-md-4 col-sm-4 col-xs-4">
                                        <div class="">
                                            <input type="radio" id="firm_type" name="firm_type" value="Partnership"
                                                <?php if ($firm_type_value == '1') { ?>checked="checked" <?php } ?> />
