         ...
         <div class="card-header">
            <div class="row">
               ...
               <div class="col-md-6 col-sm-6 col-xs-12 text-right">
                  <a href="<?php echo base_url('Admin/ManageUnitGroup');?>" class="btn btn-primary btn-sm waves-effect waves-light m-1">Back</a>
               </div>
            </div>
               ...
               <div class="row">
                  <div class="col-md-4 col-sm-4 col-xs-12">
                     <div class="form-group row">
                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12">
                           <?php $unit_group_value = '';
                              if($this->input->post('submit')) {
                              $unit_group_value = $this->input->post('unit_group');	 
                              } else if(!empty($unit_group_info)) {
                                  $unit_group_value = $unit_group_info->unit_group;
                              }?>
                           <input type="text" required id="unit_group" name="unit_group" placeholder="Enter your unit group" class="form-control" maxlength="255" value="<?php echo $unit_group_value;?>" />
                           <span class="badge badge-danger m-1"><?php echo form_error('unit_group');?></span>
                        </div>
                     </div>
                  </div>
                  <div class="col-md-4 col-sm-4 col-xs-12">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-6">
                           ...
                           <?php $display_value = '';
                              if($this->input->post('submit')) {
                                 ...
                                 $display_value = $unit_group_info->display;
                              }?>
                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12">
                           <?php $priority_value = '';
                              ...
                              $priority_value = $this->input->post('priority');	 
                                  ...
                                  $priority_value = $unit_group_info->priority;
                              }?>
