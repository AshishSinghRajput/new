...
class ManageDebitNote extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $load_permission = $this->customlib->setUsersLogs($login_info, ACCOUNT_MANAGE_DEBIT_NOTE, base_url($this->uri->uri_string()));
        ...
        $this->load->view('Account/debit_note_list', $data);
    ...
    public function view($debit_note_mst_id)
    {
        ...
        $this->load->view('layout/header', $data);
        $this->load->view('Account/debit_note_view', $data);
        $this->load->view('layout/footer', $data);
    }
    ...
    public function add($supplier_id = '')
    {
        ...
        if ($this->form_validation->run() == false) {
            if (!$this->input->post('submit')) {
                $this->load->view('layout/header', $data);
                $this->load->view('Account/debit_note_add', $data);
                $this->load->view('layout/footer', $data);
		...
		if($this->form_validation->run()==false) {
            if(!$this->input->post('submit')) {                
                ...
                if ($debit_note_info->is_cancel == '1') {
                    ...
                    $this->load->view('layout/header', $data);
                    $this->load->view('Account/debit_note_cancel', $data);
                    $this->load->view('layout/footer', $data);
                }
    ...
    public function prints($debit_note_mst_id) {
        ...
        $this->load->view('Account/debit_note_prints', $data);
    }
