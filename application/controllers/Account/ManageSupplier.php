...
class ManageSupplier extends CI_Controller {
    ...
    public function index() {
        ...
        $load_permission = $this->customlib->setUsersLogs($login_info, ACCOUNT_MANAGE_SUPPLIER, base_url($this->uri->uri_string()));
        ...
        $this->load->view('Account/supplier_list', $data);
    ...
    public function view($supplier_id) {
        ...
        $this->load->view('layout/header', $data);
        $this->load->view('Account/supplier_view', $data);
        $this->load->view('layout/footer', $data);
    }
    ...
    public function add() {
		...
		if($this->form_validation->run()==false) {
            if(!$this->input->post('submit')) {
                $this->load->view('layout/header', $data);
                $this->load->view('Account/supplier_add', $data);
                $this->load->view('layout/footer', $data);
    ...
    public function edit($supplier_id) {
		...
		if($this->form_validation->run()==false) {
            if(!$this->input->post('submit')) {
                ...
                $this->load->view('layout/header', $data);
                $this->load->view('ACCOUNT/supplier_edit', $data);
                $this->load->view('layout/footer', $data);
