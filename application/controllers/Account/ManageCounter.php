...
class ManageCounter extends CI_Controller {
    ...
    public function index() {
        ...
        $this->load->view('Account/counter_list', $data);
    ...
    public function view($counter_id) {
        ...
        $this->load->view('layout/header', $data);
        $this->load->view('Account/counter_view', $data);
        $this->load->view('layout/footer', $data);
    }
    ...
    public function add() {
		...
		if($this->form_validation->run()==false) {
            if(!$this->input->post('submit')) {
                $this->load->view('layout/header', $data);
                $this->load->view('Account/counter_add', $data);
                $this->load->view('layout/footer', $data);
    ...
    public function edit($counter_id) {
		...
		if($this->form_validation->run()==false) {
            if(!$this->input->post('submit')) {
                ...
                $this->load->view('layout/header', $data);
                $this->load->view('Account/counter_edit', $data);
                $this->load->view('layout/footer', $data);
