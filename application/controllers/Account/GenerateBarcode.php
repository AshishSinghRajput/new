...
class GenerateBarcode extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $this->load->view('Account/generate_barcode_list', $data);
    ...
    public function view($generate_barcode_id)
    {
        ...
        $this->load->view('layout/header', $data);
        $this->load->view('Account/generate_barcode_view', $data);
        $this->load->view('layout/footer', $data);
    }
    ...
    public function add()
    {
        ...
        if ($this->form_validation->run() == false) {
            if (!$this->input->post('submit')) {
                $this->load->view('layout/header', $data);
                $this->load->view('Account/generate_barcode_add', $data);
                $this->load->view('layout/footer', $data);
