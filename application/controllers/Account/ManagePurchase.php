...
class ManagePurchase extends CI_Controller {
    ...
    public function index()
    {
        ...
        $this->load->view('Account/purchase_list', $data);
    ...
    public function view($purchase_mst_id)
    {
        ...
        $this->load->view('layout/header', $data);
        $this->load->view('Account/purchase_view', $data);
        $this->load->view('layout/footer', $data);
    }
    ...
    public function add() {
        ...
        if ($this->form_validation->run() == false) {
            if (!$this->input->post('submit')) {
                $this->load->view('layout/header', $data);
                $this->load->view('Account/purchase_add', $data);
                $this->load->view('layout/footer', $data);
            ...
            for ($counter = 0; $counter < count($purcahse_details); $counter++) {
                ...
                $total_rate = $total_rate + $purcahse_details[$counter]['total_rate'];
            }
            ...
            $purcahse_mst_data['total_rate'] = $total_rate;
            ...
            for ($counter = 0; $counter < count($purcahse_details); $counter++) {
                ...
                $purcahse_det_data['rate'] = $purcahse_details[$counter]['rate'];
                $purcahse_det_data['total_mrp'] = $purcahse_details[$counter]['total_mrp'];
                $purcahse_det_data['total_rate'] = $purcahse_details[$counter]['total_rate'];
                $purcahse_det_data['cgst'] = '0'; //$purcahse_details[$counter]['total_rate'];
                $purcahse_det_data['sgst'] = '0'; //$purcahse_details[$counter]['total_rate'];
                $purcahse_det_data['igst'] = '0'; //$purcahse_details[$counter]['total_rate'];
                $purcahse_det_data['total_amount'] = $purcahse_details[$counter]['total_rate'];
                ...
                $product_account_det_data['rate'] = $purcahse_details[$counter]['rate'];
                $product_account_det_data['total_mrp'] = $purcahse_details[$counter]['total_mrp'];
                $product_account_det_data['total_rate'] = $purcahse_details[$counter]['total_rate'];
                ...
                $product_account_det_data['total_amount'] = $purcahse_details[$counter]['total_rate'];
		...
		if($this->form_validation->run()==false) {
            if(!$this->input->post('submit')) {        
                ...
                if ($purchase_mst_info->is_cancel == '1') {
                    ...
                    $this->load->view('layout/header', $data);
                    $this->load->view('Account/purchase_cancel', $data);
                    $this->load->view('layout/footer', $data);
    ...
    public function prints($purchase_mst_id) {
        ...
        $this->load->view('Account/purchase_prints', $data);
    }
    ...
    public function purcahse_validation($required = true) {
        ...
        $this->form_validation->set_rules('purcahse_net_rate', 'Net Rate', 'trim|required|numeric|min_length[1]|max_length[10]'); 
    ...
    public function remove_item($item_id)
    {
        ...
        for ($counter = 0; $counter < count($purcahse_details); $counter++) {
            if ($counter != $item_id) {
                $session['purcahse_details'][] = array(
                    ...
                    'rate' => $purcahse_details[$counter]['rate'],
                    'total_mrp' => $purcahse_details[$counter]['total_mrp'],
                    'total_rate' => $purcahse_details[$counter]['total_rate']
                );
            }
        }
        $this->session->unset_userdata('purcahse_details');
        ...
        redirect(base_url('Account/ManagePurchase/add'));
    }
