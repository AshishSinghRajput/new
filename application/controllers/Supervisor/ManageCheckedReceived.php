...
class ManageCheckedReceived extends CI_Controller {
    ...
    public function index() {
        ...
        $load_permission = $this->customlib->setUsersLogs($login_info, SUPERVISOR_MANAGE_CHECKEDBY_RECEIVEDBY, base_url($this->uri->uri_string()));
        ...
        $this->load->view('Supervisor/checked_received_list', $data);
    ...
    public function view($checked_received_id) {
        ...
        $this->load->view('layout/header', $data);
        $this->load->view('Supervisor/checked_received_view', $data);
        $this->load->view('layout/footer', $data);
    }
    ...
    public function add() {
		...
		if($this->form_validation->run()==false) {
            if(!$this->input->post('submit')) {
                $this->load->view('layout/header', $data);
                $this->load->view('Supervisor/checked_received_add', $data);
                $this->load->view('layout/footer', $data);
            ...
            if($checked_received_id > 0) {                    
                ...
                redirect('Supervisor/ManageCheckedReceived');

            } else {
                $this->session->set_flashdata('error_msg', $this->lang->line('insert_update_error_message'));
                redirect('Supervisor/ManageCheckedReceived/add');
    ...
    public function edit($checked_received_id) {
		...
		if($this->form_validation->run()==false) {
            if(!$this->input->post('submit')) {
                ...
                $this->load->view('layout/header', $data);
                $this->load->view('Supervisor/checked_received_edit', $data);
                $this->load->view('layout/footer', $data);
