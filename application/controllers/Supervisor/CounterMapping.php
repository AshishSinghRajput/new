...
class CounterMapping extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $this->load->view('Supervisor/counter_mapping_list', $data);
    ...
    public function view($counter_mapping_id)
    {
        ...
        $this->load->view('layout/header', $data);
        $this->load->view('Supervisor/counter_mapping_view', $data);
        $this->load->view('layout/footer', $data);
    }
    ...
    public function add()
    {
        ...
        if ($this->form_validation->run() == false) {
            if (!$this->input->post('submit')) {
                $this->load->view('layout/header', $data);
                $this->load->view('Supervisor/counter_mapping_add', $data);
                $this->load->view('layout/footer', $data);
    ...
    public function edit($counter_mapping_id)
    {
        ...
        if ($this->form_validation->run() == false) {
            if (!$this->input->post('submit')) {
                ...
                $this->load->view('layout/header', $data);
                $this->load->view('Supervisor/counter_mapping_edit', $data);
                $this->load->view('layout/footer', $data);
            } else {
                $this->load->view('layout/header', $data);
                $this->load->view('Supervisor/counter_mapping_edit', $data);
