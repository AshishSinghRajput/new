...
class SupplierAccountDetModel extends CI_Model {
    //put your code here
    private $table_name = 'supplier_account_det';

    public function get_record($finyear_id, $store_id, $supplier_id = '', $supplier_account_mst_id = '') {
        $query = "SELECT `supplier_account_det_id`, `invoice_no`, `date`, `store_id`, `supplier_id`, `supplier_account_mst_id`, `master_id`, `account_id`, `account`, `dues_amount`, `total_quantity`, `total_mrp`, `total_rate`, `total_cgst`, `total_sgst`, `total_igst`, `transport_charges`, `other_charges`, `net_amount`, `adjustment`, `grand_total`, `round_off`, `amount_word`, `remarks`, `payment_mode_id`, `payment_mode`, `bank_id`, `transaction_no`, `transaction_date`, `branch`, `status_id`, `status_date`, `status_remarks`, `is_cancel`, `cancel_date`, `cancel_reason`, `finyear_id`, `created_date`, `created_time`, `created_by`, `created_name`, `created_user_agent`, `created_ip`, `updated_date`, `updated_time`, `updated_by`, `updated_name`, `updated_user_agent`, `updated_ip` FROM `supplier_account_det` ";        
